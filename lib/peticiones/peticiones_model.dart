...
class PeticionesModel extends ChangeNotifier {
  ...
  Future<void> fetchApiSolicitud() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          'https://apiuniviaje-pgport.up.railway.app/api/solicitudes/$idusuariconductor'));
  ...
  Future<void> updateSolicitud(int? idusuariopasajero, int? idruta) async {
    final url =
        'https://apiuniviaje-pgport.up.railway.app/api/solicitud/$idusuariopasajero/$idruta';
  ...
  Future<void> terminarRuta() async {
    final url = 'https://apiuniviaje-pgport.up.railway.app/api/ruta/$id';
    print(idusuariopasajero);
    try {
      final body = <String, dynamic>{
        'aceptacion': true.toString(),
